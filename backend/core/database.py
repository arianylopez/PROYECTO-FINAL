...
# Bases de datos físicamente separadas en el servidor
AUTH_DB_URL = f"postgresql://{DB_USER}:{DB_PASSWORD}@{settings.DB_HOST}:{settings.DB_PORT}/auth_db"
BUSINESS_DB_URL = f"postgresql://{DB_USER}:{DB_PASSWORD}@{settings.DB_HOST}:{settings.DB_PORT}/business_db"
