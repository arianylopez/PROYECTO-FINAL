      ...
      >
        ...
        <div style={{ padding: '1.75rem', borderBottom: '1px solid #262932', backgroundColor: '#1e222b' }}>
          ...
          <p style={{ color: '#9ca3af', margin: '0.4rem 0 0 0', fontSize: '0.95rem' }}>
            Función: <strong style={{ color: '#fff' }}>{screeningTime}</strong> • Sala:{' '}
            <strong style={{ color: '#fff' }}>{screeningRoom}</strong>
          </p>
        </div>
        ...
        >
          {ticketTypes.map((type) => {
            ...
            return (
              ...
              >
                <div>
                  <h4 style={{ margin: '0 0 0.2rem 0', color: '#ffffff', fontSize: '1.1rem', fontWeight: '700' }}>
                    {type.name}
                  </h4>
        ...
        >
          <span style={{ color: '#9ca3af' }}>
            Total boletos: <strong style={{ color: '#ffffff' }}>{totalTickets}</strong>
          </span>
          <span style={{ color: '#9ca3af' }}>
            Total a pagar:{' '}
            <strong style={{ color: '#f4e951', fontSize: '1.25rem' }}>Bs. {totalPrice.toFixed(2)}</strong>
          </span>
        </div>
