...
const ArrowDownIcon = ({ className }: { className?: string }) => (
  <svg fill="none" stroke="currentColor" viewBox="0 0 24 24" width="16" height="16" className={className}>
    ...
    <>
      <header className="header">
        ...
        <div className="header__pill">
          <div className="header__search">
            ...
            <form
              ...
              style={{ width: isSearchOpen ? '220px' : '0', opacity: isSearchOpen ? 1 : 0 }}
            >
              <input
                ref={searchInputRef}
                type="text"
            ...
            <div className="header__user-menu" ref={dropdownRef}>
              ...
              <div className={`header__dropdown ${isDropdownOpen ? 'header__dropdown--active' : ''}`}>
                ...
                <button
                  ...
                  onClick={() => {
                    navigate('/me/orders?tab=tickets');
                    setIsDropdownOpen(false);
                  }}
                >
                ...
                <button
                  className="header__dropdown-item"
                  onClick={() => {
                    navigate('/me/orders?tab=activity');
                    setIsDropdownOpen(false);
                  }}
                >
        ...
        <div className={`header__mobile-nav ${isMobileMenuOpen ? 'header__mobile-nav--active' : ''}`}>
          <button className="header__mobile-link" onClick={() => navigate('/home')}>
            Cartelera
          </button>
          <button className="header__mobile-link" onClick={() => navigate('/home')}>
            Próximamente
          </button>
          <button className="header__mobile-link" onClick={() => alert('Próximamente: Cines')}>
            Cines
          </button>
          ...
          {user ? (
            <>
              ...
              <button className="header__mobile-link header__dropdown-item--logout" onClick={handleLogout}>
                <LogoutIcon /> Cerrar Sesión
              </button>
            </>
          ) : (
